function autocomplete(inp_text,inp_val, arr) {
        ...
        for (i = 0; i < arr.length; i++) {
            ...
            if (arr[i].text.substr(0, val.length).toUpperCase() == val.toUpperCase()) {
                ...
                b.addEventListener("click", function (e) {
                    ...
                    inp_text.value = this.getElementsByTagName("input")[0].value;
                    inp_val.value = this.getElementsByTagName("input")[1].value;
    ...
    inp_text.addEventListener("keydown", function (e) {
